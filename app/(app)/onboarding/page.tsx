      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <fieldset>
          <legend className="text-sm font-medium text-[var(--text)]">
            Interests <span className="font-normal text-[var(--text-3)]">- pick any</span>
          </legend>
        ...
        <fieldset>
          <legend className="text-sm font-medium text-[var(--text)]">
            Dietary restrictions <span className="font-normal text-[var(--text-3)]">- pick any that apply</span>
          </legend>
          <div className="mt-3 flex flex-wrap gap-2">
            {DIETARY.map(opt => (
              <ChoicePill
